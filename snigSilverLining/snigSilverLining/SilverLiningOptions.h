#ifndef BYY_DRIVER_SILVERLINING_OPTIONS
#define BYY_DRIVER_SILVERLINING_OPTIONS 1
...
/**
    ...
    */
class /*header only*/ ByySilverLiningOptions : public osgEarth::Util::SkyOptions
{
public:
    ByySilverLiningOptions(const osgEarth::Util::SkyOptions& options =osgEarth::Util::SkyOptions()) :
    ...
    virtual ~ByySilverLiningOptions() { }
...
#endif // BYY_DRIVER_SILVERLINING_OPTIONS
