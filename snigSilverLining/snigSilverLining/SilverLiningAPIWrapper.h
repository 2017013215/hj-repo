#ifndef BYY_SILVERLINING_API_WRAPPER
#define BYY_SILVERLINING_API_WRAPPER 1
...
class SNIGSILVERLINING_EXPORT CloudLayer
{
public:
...
class SNIGSILVERLINING_EXPORT CloudLayerFactory
{
public:
	static CloudLayer Create(int kind);
};

class SNIGSILVERLINING_EXPORT WindVolume
{
public:
	WindVolume();
...
class SNIGSILVERLINING_EXPORT AtmosphericConditions
{
public:
...
class SNIGSILVERLINING_EXPORT Atmosphere
{
public:
...
#endif // BYY_SILVERLINING_API_WRAPPER
