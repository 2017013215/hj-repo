...
TextEdit::TextEdit( const QString& str,QWidget *parent /*= 0*/ ,Qt::WindowFlags flags) 
	: QMainWindow(parent,flags),_modifed(false)
{
	...
	setWindowTitle(QString::fromLocal8Bit("编辑[*]"));
...
// 		e->ignore();
	...
	if (textEdit->document()->isModified())
	{
		...
		ret = QMessageBox::warning(this, QString::fromLocal8Bit("提示"),
			QString::fromLocal8Bit("内容已经修改，是否保存？"),
