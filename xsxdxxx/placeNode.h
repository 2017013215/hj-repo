...
*/
#ifndef OSGEARTH_ANNOTATION_BYYPLACE_NODE_H
#define OSGEARTH_ANNOTATION_BYYPLACE_NODE_H 1
...
namespace osgEarth { namespace Annotation
{
     ...
     */
    class ByyPlaceNode : public GeoPositionNode
    {
    public:
        META_AnnotationNode(osgEarthAnnotation, ByyPlaceNode);
    ...
    public: // GeoPositionNode override
		...
		void setIconColor(const osg::Vec4& color);

    protected:

        virtual ~ByyPlaceNode() { }

        osg::ref_ptr<osg::Image>           _image;
        std::string                        _text;
        Style                              _style;
		osg::ref_ptr<class osg::Geode>     _geode;
		class osg::Geode*                  _geode2;
        osg::ref_ptr<const osgDB::Options> _dbOptions;
        osg::ref_ptr<ScreenSpaceLayoutData> _dataLayout;
		osg::ref_ptr<ScreenSpaceLayoutData> _textDataLayout;
		osg::Vec4							_imageColor;
    ...
    public:
		...
		void setTerrain(osgEarth::Terrain * pTerrain);
    private:
        ByyPlaceNode(const ByyPlaceNode& rhs, const osg::CopyOp& op =osg::CopyOp::DEEP_COPY_ALL) : GeoPositionNode(rhs, op) { }
		void updateGeometryColor(osg::Geometry* geom,const osg::Vec4& color);
    };

} } // namespace osgEarth::Annotation

#endif //OSGEARTH_ANNOTATION_BYYPLACE_NODE_H
