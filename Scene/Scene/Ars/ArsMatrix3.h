    ...
    */
    ...
    public:
        ...
        */
        ...
        ARS_BASE_API friend Vec3 operator* (const Vec3& rkVector,
        ...
        // scalar * matrix
        ARS_BASE_API friend Matrix3 operator* (Real fScalar, const Matrix3& rkMatrix);
